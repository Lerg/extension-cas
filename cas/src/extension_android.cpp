...
static jmethodID java_extension_validate_integration = NULL;
...
static jmethodID java_extension_set = NULL;
...
int EXTENSION_VALIDATE_INTEGRATION(lua_State *L) {
	...
	if (java_extension_object != NULL) {
		ThreadAttacher attacher;
		result = attacher.env->CallIntMethod(java_extension_object, java_extension_validate_integration, (jlong)L);
	}
	return result;
}
...
int EXTENSION_SET(lua_State *L) {
	...
	if (java_extension_object != NULL) {
		ThreadAttacher attacher;
		result = attacher.env->CallIntMethod(java_extension_object, java_extension_set, (jlong)L);
	}
	return result;
}
...
void EXTENSION_INITIALIZE(lua_State *L) {
	...
	java_extension_validate_integration = env->GetMethodID(java_extension_class, "validate_integration", "(J)I");
	...
	java_extension_set = env->GetMethodID(java_extension_class, "set", "(J)I");
