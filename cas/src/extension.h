...
#define EXTENSION_VALIDATE_INTEGRATION FUNCTION_NAME_EXPANDED(EXTENSION_NAME, validate_integration)
...
#define EXTENSION_SET FUNCTION_NAME_EXPANDED(EXTENSION_NAME, set)
